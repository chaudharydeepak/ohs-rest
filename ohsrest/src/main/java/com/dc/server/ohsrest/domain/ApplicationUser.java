...
public class ApplicationUser
{
	...
	public ApplicationUser(String login, String name, String password, String... roles)
	{
		this.login = login;
		this.name = name;
	...
	{
		return this == o
				|| o != null && o instanceof ApplicationUserJwt && Objects.equals(login, ((ApplicationUser) o).login);
	}
