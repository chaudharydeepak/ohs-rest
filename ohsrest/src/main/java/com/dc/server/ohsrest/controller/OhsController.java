...
import com.dc.server.ohsrest.security.AuthenticationService;
import com.dc.server.ohsrest.security.TokenInfo;
import com.dc.server.ohsrest.security.TokenManager;
...
public class OhsController
{
	...
	// I don't want to mess with RoleVoters - that's why ADMIN does NOT have access
	// to this page
	@Secured(
	{ "ROLE_SPECIAL", "ADMIN" })
